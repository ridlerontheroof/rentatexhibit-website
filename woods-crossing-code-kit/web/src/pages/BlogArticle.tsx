...
export default function BlogArticle() {
  ...
  const article = verifiedContent.blog.find((a) => a.slug === params.slug);
  ...
  if (!article) {
    return (
      <div className="py-24 px-4 md:px-8 max-w-3xl mx-auto w-full text-center">
        ...
        <p className="text-muted-foreground mb-8">The post you requested could not be found.</p>
        <Link href="/blog" className="text-primary hover:underline">Return to Property Journal</Link>
      </div>
    );
  }
