# Standards gap report — https://www.siennachicago.com

Manifest: v1.0.0 (standard: Exhibit On Superior production implementation (rentatexhibit.com))
Generated: 2026-08-16T18:06:49.106Z

**Summary:** FAIL: 2 · SKIPPED: 11 · KIT-GUARD: 20 · MANUAL: 1

| Check | Category | Status | Detail |
|---|---|---|---|
| `head.per-url` | canonicals/metadata | **FAIL** | 27 inventoried pages: 0 missing title, 5 missing description (offline inventory) |
| `head.canonical-self` | canonicals/metadata | **FAIL** | 2/27 pages missing canonical (offline inventory) |
