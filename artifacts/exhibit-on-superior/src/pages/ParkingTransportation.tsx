            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-border p-8">
                ...
                <ul className="mt-4 space-y-3">
                  ...
                  <li className="flex items-start gap-3"><span className="text-primary mt-1">•</span><span><strong>EV charging</strong> &mdash; 3 EVBOX level-2 charging stations on the second garage level, each with 2 reserved EV spaces (6 total); pricing and subscriptions managed by EVBOX</span></li>
