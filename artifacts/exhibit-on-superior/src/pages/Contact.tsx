...
export function Contact() {
  ...
  return (
    <div>
      <PageHero
        image="/images/assets/images/image-084-20170601-0076-p0s5be.jpg"
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-3xl uppercase tracking-wider mb-8">Get in Touch</h2>
              <p className="text-lg leading-relaxed mb-8">
                Have questions about floor plans, pricing, or availability? Our leasing team is ready to assist you. Reach out today and discover why Exhibit on Superior is the perfect place to call home.
              </p>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg uppercase tracking-wider mb-1">Leasing Office Hours</h3>
                    <p>
